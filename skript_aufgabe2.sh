...
grep -v IMPORTANT 2022-11-25-Article_list_dirty.tsv | cut -f 5,12 | sed '1d' > erg_dirty.tsv
grep IMPORTANT 2022-11-25-Article_list_dirty.tsv | cut -f 7,14 >> erg_dirty.tsv
